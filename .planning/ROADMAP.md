...
Plans:
- [ ] 11-01-PLAN.md -- Fix syllabus filenames, verify build, MCP tools, and prerequisite chain
- [ ] 11-02-PLAN.md -- Deploy to Vercel, verify skills, theme consistency, and production URL
...
| Agent Feedback Loops (AF) | 10 | 2/3 | In Progress|  | Tool Orchestration (TO) | 10 | Phase 9 | TO-01 through TO-10 |
...
| 11. Integration + Deployment | v1.1 | 0/2 | PLANNED | - |
