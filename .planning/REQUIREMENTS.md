...
- [ ] **ST004-01**: Student can import a JSON agent execution trace (schema: agent name, steps with tool calls, timestamps, token counts) and see it auto-mapped as a CLD with feedback loops detected
